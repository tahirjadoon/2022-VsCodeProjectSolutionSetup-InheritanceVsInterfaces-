...
public class RentalBoat : RentalVehicle
{
    ...
    public RentalBoat() : base(_foregroundColro1, _foregroundColor2)
    {
    }

    public RentalBoat(ConsoleColor foregroundColor1, ConsoleColor foregroundColor2) : base(foregroundColor1, foregroundColor2)
    {
